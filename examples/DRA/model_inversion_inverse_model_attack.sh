...
nohup python -u model_inversion_inverse_model_attack.py --device cuda:1 --dataset CIFAR10 --model VGG5 --split_layer 1  > ../../results/inverse-model-results-20240414/VGG5/InverseModelAttack-defense0.1/InverseNetwork-layer1-gpu.log 2>&1 &
nohup python -u model_inversion_inverse_model_attack.py --device cuda:1 --dataset CIFAR10 --model VGG5 --split_layer 2  > ../../results/inverse-model-results-20240414/VGG5/InverseModelAttack-defense0.1/InverseNetwork-layer2-gpu.log 2>&1 &
nohup python -u model_inversion_inverse_model_attack.py --device cuda:1 --dataset CIFAR10 --model VGG5 --split_layer 3  > ../../results/inverse-model-results-20240414/VGG5/InverseModelAttack-defense0.1/InverseNetwork-layer3-gpu.log 2>&1 &
nohup python -u model_inversion_inverse_model_attack.py --device cuda:1 --dataset CIFAR10 --model VGG5 --split_layer 4  > ../../results/inverse-model-results-20240414/VGG5/InverseModelAttack-defense0.1/InverseNetwork-layer4-gpu.log 2>&1 &
nohup python -u model_inversion_inverse_model_attack.py --device cuda:1 --dataset CIFAR10 --model VGG5 --split_layer 5  > ../../results/inverse-model-results-20240414/VGG5/InverseModelAttack-defense0.1/InverseNetwork-layer5-gpu.log 2>&1 &
nohup python -u model_inversion_inverse_model_attack.py --device cuda:1 --dataset CIFAR10 --model VGG5 --split_layer 6  > ../../results/inverse-model-results-20240414/VGG5/InverseModelAttack-defense0.1/InverseNetwork-layer6-gpu.log 2>&1 &
