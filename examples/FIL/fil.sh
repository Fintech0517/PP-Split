...
###
 ...
 # @LastEditTime: 2024-09-30 01:12:18
...
# VGG9
# nohup python -u fil.py --device cuda:0 --dataset CIFAR10 --model VGG9 --split_layer 1  > ../../results/20240904-fisher/VGG9/drjCodeFIL/inverse_dFIL-layer0-gpu.log 2>&1 &
# nohup python -u fil.py --device cuda:1 --dataset CIFAR10 --model VGG9 --split_layer 2  > ../../results/20240904-fisher/VGG9/drjCodeFIL/inverse_dFIL-layer1-gpu.log 2>&1 &
# nohup python -u fil.py --device cuda:1 --dataset CIFAR10 --model VGG9 --split_layer 3  > ../../results/20240904-fisher/VGG9/drjCodeFIL/inverse_dFIL-layer2-gpu.log 2>&1 &
# nohup python -u fil.py --device cuda:1 --dataset CIFAR10 --model VGG9 --split_layer 4  > ../../results/20240904-fisher/VGG9/drjCodeFIL/inverse_dFIL-layer3-gpu.log 2>&1 &
# nohup python -u fil.py --device cuda:1 --dataset CIFAR10 --model VGG9 --split_layer 5  > ../../results/20240904-fisher/VGG9/drjCodeFIL/inverse_dFIL-layer4-gpu.log 2>&1 &
# nohup python -u fil.py --device cuda:1 --dataset CIFAR10 --model VGG9 --split_layer 6  > ../../results/20240904-fisher/VGG9/drjCodeFIL/inverse_dFIL-layer5-gpu.log 2>&1 &
# nohup python -u fil.py --device cuda:1 --dataset CIFAR10 --model VGG9 --split_layer 7 > ../../results/20240904-fisher/VGG9/drjCodeFIL/inverse_dFIL-layer6-gpu.log 2>&1 &
