...
LastEditTime: 2024-09-09 22:08:00
LastEditors: Ruijun Deng
FilePath: /PP-Split/examples/effectInfo/effectInfo1.5.py
Description: 
'''
# 导包
import torch
...
# nohup python -u effectInfo1.5.py > ../../results/20240702-effectiveInfo/Resnet18/effectiveInfo1.5/effectInfo1.5-pool4-layer11-gpu.log 2>&1 &
# nohup python -u effectInfo1.5.py > ../../results/20240702-effectiveInfo/VGG5/effectiveInfo1.5/effectInfo1.5-pool4-layer5-gpu.log 2>&1 &
...
for j, data in enumerate(tqdm.tqdm(one_data_loader)): # 测试第一个testloader
    ...
    # effectFisher = computing_diag_det_with_outputs(model=client_net, inputs=images, outputs=outputs,sigmas = 0.01)
    effectFisher = computing_diag_det_with_outputs(model=client_net, inputs=images, outputs=outputs,sigmas = 1.0)

    # 存储
    # effecInfo_same_layer_list.append(effectEntro-effectFisher)
    effecInfo_same_layer_list.append(-effectFisher+effectUniform)
