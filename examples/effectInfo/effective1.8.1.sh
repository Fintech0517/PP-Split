###
 ...
 # @LastEditTime: 2024-10-02 21:32:01
...
# Purchase100
# nohup python -u effectInfo1.8.1.py --device cuda:0 --dataset purchase --split_layer 3  > ../../results/20240702-effectiveInfo/Purchase/effectiveInfo1.8.1/effectInfo1.8.1-layer3-gpu.log 2>&1 &


# Iris
# nohup python -u effectInfo1.8.1.py --device cuda:0 --dataset Iris --split_layer 3  > ../../results/20240702-effectiveInfo/Purchase/effectiveInfo1.8.1/effectInfo1.8.1-layer3-gpu.log 2>&1 &



# VGG9 CIFAR10 [1,4,7,9,10,11,12,13]
# nohup python -u effectInfo1.8.1.py --device cuda:0 --dataset CIFAR10 --model VGG9 --split_layer 1  > ../../results/20240702-effectiveInfo/VGG9/effectiveInfo1.8.1/pool4-layer1-gpu.log 2>&1 &
# nohup python -u effectInfo1.8.1.py --device cuda:0 --dataset CIFAR10 --model VGG9 --split_layer 2  > ../../results/20240702-effectiveInfo/VGG9/effectiveInfo1.8.1/pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.8.1.py --device cuda:0 --dataset CIFAR10 --model VGG9 --split_layer 3  > ../../results/20240702-effectiveInfo/VGG9/effectiveInfo1.8.1/pool4-layer3-gpu.log 2>&1 &
# nohup python -u effectInfo1.8.1.py --device cuda:0 --dataset CIFAR10 --model VGG9 --split_layer 4  > ../../results/20240702-effectiveInfo/VGG9/effectiveInfo1.8.1/pool4-layer4-gpu.log 2>&1 &
# nohup python -u effectInfo1.8.1.py --device cuda:0 --dataset CIFAR10 --model VGG9 --split_layer 5  > ../../results/20240702-effectiveInfo/VGG9/effectiveInfo1.8.1/pool4-layer5-gpu.log 2>&1 &
# nohup python -u effectInfo1.8.1.py --device cuda:0 --dataset CIFAR10 --model VGG9 --split_layer 6  > ../../results/20240702-effectiveInfo/VGG9/effectiveInfo1.8.1/pool4-layer6-gpu.log 2>&1 &
# nohup python -u effectInfo1.8.1.py --device cuda:0 --dataset CIFAR10 --model VGG9 --split_layer 7  > ../../results/20240702-effectiveInfo/VGG9/effectiveInfo1.8.1/pool4-layer7-gpu.log 2>&1 &
# nohup python -u effectInfo1.8.1.py --device cuda:0 --dataset CIFAR10 --model VGG9 --split_layer 9  > ../../results/20240702-effectiveInfo/VGG9/effectiveInfo1.8.1/pool4-layer9-gpu.log 2>&1 &
# nohup python -u effectInfo1.8.1.py --device cuda:0 --dataset CIFAR10 --model VGG9 --split_layer 10  > ../../results/20240702-effectiveInfo/VGG9/effectiveInfo1.8.1/pool4-layer10-gpu.log 2>&1 &
# nohup python -u effectInfo1.8.1.py --device cuda:0 --dataset CIFAR10 --model VGG9 --split_layer 11  > ../../results/20240702-effectiveInfo/VGG9/effectiveInfo1.8.1/pool4-layer11-gpu.log 2>&1 &
# nohup python -u effectInfo1.8.1.py --device cuda:0 --dataset CIFAR10 --model VGG9 --split_layer 12  > ../../results/20240702-effectiveInfo/VGG9/effectiveInfo1.8.1/pool4-layer12-gpu.log 2>&1 &
# nohup python -u effectInfo1.8.1.py --device cuda:0 --dataset CIFAR10 --model VGG9 --split_layer 13  > ../../results/20240702-effectiveInfo/VGG9/effectiveInfo1.8.1/pool4-layer13-gpu.log 2>&1 &
...
# ResNet18 CIFAR100
nohup python -u effectInfo1.8.1.py  --device cuda:0 --dataset CIFAR100 --model ResNet18 --split_layer 2 > ../../results/20240702-effectiveInfo/Resnet18_CIFAR100/effectiveInfo1.8.1/pool4-layer2-gpu.log 2>&1 &
nohup python -u effectInfo1.8.1.py  --device cuda:0 --dataset CIFAR100 --model ResNet18 --split_layer 3 > ../../results/20240702-effectiveInfo/Resnet18_CIFAR100/effectiveInfo1.8.1/pool4-layer3-gpu.log 2>&1 &
nohup python -u effectInfo1.8.1.py  --device cuda:0 --dataset CIFAR100 --model ResNet18 --split_layer 5 > ../../results/20240702-effectiveInfo/Resnet18_CIFAR100/effectiveInfo1.8.1/pool4-layer5-gpu.log 2>&1 &
nohup python -u effectInfo1.8.1.py  --device cuda:0 --dataset CIFAR100 --model ResNet18 --split_layer 7 > ../../results/20240702-effectiveInfo/Resnet18_CIFAR100/effectiveInfo1.8.1/pool4-layer7-gpu.log 2>&1 &
nohup python -u effectInfo1.8.1.py  --device cuda:0 --dataset CIFAR100 --model ResNet18 --split_layer 9 > ../../results/20240702-effectiveInfo/Resnet18_CIFAR100/effectiveInfo1.8.1/pool4-layer9-gpu.log 2>&1 &
nohup python -u effectInfo1.8.1.py  --device cuda:0 --dataset CIFAR100 --model ResNet18 --split_layer 11 > ../../results/20240702-effectiveInfo/Resnet18_CIFAR100/effectiveInfo1.8.1/pool4-layer11-gpu.log 2>&1 &
