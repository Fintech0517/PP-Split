###
 ...
 # @LastEditTime: 2024-10-06 04:10:00
...
# different epochs
# vgg5 MNIST
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 0 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 1 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/1ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 2 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/2ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 3 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/3ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 4 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/4ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 5 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/5ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 6 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/6ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 7 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/7ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 8 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/8ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 9 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/9ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 10 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/10ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 11 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/11ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 12 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/12ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 13 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/13ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 14 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/14ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 15 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/15ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 16 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/16ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 17 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/17ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 18 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/18ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 19 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/19ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG5_MNIST --split_layer 2 --ep 20 > ../../results/20240702-effectiveInfo/VGG5_MNIST/VGG5_0ep/effectiveInfo1.10/20ep-pool4-layer2-gpu.log 2>&1 &



# different epochs
# vgg9 MNIST
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 0 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 1 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/1ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 2 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/2ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 3 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/3ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 4 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/4ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 5 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/5ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 6 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/6ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 7 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/7ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 8 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/8ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 9 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/9ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:1 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 10 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/10ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 11 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/11ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 12 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/12ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 13 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/13ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 14 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/14ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 15 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/15ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 16 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/16ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 17 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/17ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 18 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/18ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 19 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/19ep-pool4-layer2-gpu.log 2>&1 &
# nohup python -u effectInfo1.10.py --device cuda:0 --dataset MNIST --model VGG9_MNIST --split_layer 4 --ep 20 > ../../results/20240702-effectiveInfo/VGG9_MNIST/VGG9_0ep/effectiveInfo1.10/20ep-pool4-layer2-gpu.log 2>&1 &
