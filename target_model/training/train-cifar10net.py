...
LastEditTime: 2024-10-27 06:18:46
LastEditors: Ruijun Deng
FilePath: /PP-Split/target_model/training/train-cifar10net.py
Description: 
'''
import os
...
# 模型
from target_model.models.ImageClassification.Maeng_FIL_nips23.densenet import densenet121, densenet161, densenet169
from target_model.models.ImageClassification.Maeng_FIL_nips23.googlenet import googlenet
from target_model.models.ImageClassification.Maeng_FIL_nips23.inception import inception_v3
from target_model.models.ImageClassification.Maeng_FIL_nips23.mobilenetv2 import mobilenet_v2
from target_model.models.ImageClassification.Maeng_FIL_nips23.vgg import vgg11_bn, vgg13_bn, vgg16_bn, vgg19_bn
...
def main(args):
    ...
    unit_net_route = f'/home/dengruijun/data/FinTech/PP-Split/results/trained_models/ImageClassification/CIFAR10-models/state_dicts/{args.classifier}.pt' # VGG5-BN+Tanh # 存储的是模型参数，不包括模型结构
    unit_net_dir = f'/home/dengruijun/data/FinTech/PP-Split/results/trained_models/ImageClassification/CIFAR10-models/drj_state_dicts/' # VGG5-BN+Tanh # 存储的是模型参数，不包括模型结构
    if args.logger == "wandb":
        # wandb.init(project="CIFAR10Net-maeng-trained", name=f'{args.classifier}-{args.dataset}')
        logger = WandbLogger(name=f'{args.classifier}-{args.dataset}', project="CIFAR10Net-maeng-trained")
