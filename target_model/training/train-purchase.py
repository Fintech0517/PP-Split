...
def train(train_loader, model, criterion, optimizer, epoch, use_cuda,num_batchs=999999):
    ...
    for ind,(inputs,targets) in enumerate(tqdm.tqdm(train_loader)):
        ...
        prec1, prec5 = accuracy_purchase(outputs.data, targets.data, topk=(1, 5))
...
if __name__ == '__main__':
    ...
    # 训练好的模型存储的dir
    model_dir = "../../results/trained_models/Purchase100/20240414/"
    ...
    for epoch in range(epochs):
        ...
        save_checkpoint({
            ...
            }, is_best,filename='epoch_train%d.pth'%(epoch+1),checkpoint=model_dir)
