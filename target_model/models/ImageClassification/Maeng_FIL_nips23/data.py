...
class CIFAR10Data(pl.LightningDataModule):
    ...
    def download_weights(): # 下载预训练模型参数 # /home/dengruijun/data/FinTech/PP-Split/results/trained_models/CIFAR10-models/state_dicts/
        url = (
        ...
        model_weights_dir='/home/dengruijun/data/FinTech/PP-Split/results/trained_models/CIFAR10-models/'
        # path_to_zip_file = os.path.join(os.getcwd(), "state_dicts.zip")
        path_to_zip_file = os.path.join(model_weights_dir, "state_dicts.zip")
        # directory_to_extract_to = os.path.join(os.getcwd(), "cifar10_models")
        directory_to_extract_to = os.path.join(model_weights_dir, "cifar10_models")
