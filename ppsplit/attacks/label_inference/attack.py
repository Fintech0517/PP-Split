...
def norm_attack(splitnn, dataloader, attack_criterion, device="cpu", marvell=False):
    epoch_labels = []
    epoch_g_norm = []
...
def direction_attack(splitnn, dataloader, attack_criterion, device="cpu", marvell=False):
    epoch_labels = []
    epoch_g_direc = []
    for i, data in enumerate(dataloader, 0):
        inputs, labels = data
