...
from ppsplit.fedml_core.preprocess.bank.preprocess_bank import preprocess
from ppsplit.fedml_core.model.bankModels import TopModel, BottomModel, BottomModelDecoder, BottomModelDecoder_layer1, BottomModelDecoder_layer2
from ppsplit.fedml_core.trainer.vfl_trainer import VFLTrainer
from ppsplit.fedml_core.utils.utils import adult_dataset, over_write_args_from_file, Similarity, onehot_softmax, tabRebuildAcc, onehot_bool_loss_v2, onehot_bool_loss, num_loss, keep_predict_loss
...
def train_decoder(net, train_queue, device, args):
    ...
    decoder = BottomModelDecoder_layer2(input_dim=net_output.shape[1], output_dim=Xb_train.shape[1]).to(device)
...
if __name__ == '__main__':
    ...
    if args.multiple:
        ...
        # 是否要规范化
        args.decoder_mode = args.decoder_mode + "modelsize2"
